...
import { hashPassword, validatePassword, generateToken, handleError, verfiyToken } from './../../utils/common';
...
const forgetPassword = async (_parent : any, args : any, ctx: Context, _info : any) => {
...
const resetPassword = async (_parent : any, args : any, ctx: Context, _info : any) => {
